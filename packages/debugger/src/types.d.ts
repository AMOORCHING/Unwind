...
export type RunStatus = "active" | "completed" | "failed" | "compensating" | "compensated" | "partially_compensated";
...
export interface CompensationFailed extends BaseEvent {
    ...
    compensatingToolCallId: string;
    reason: "append_only_no_compensation" | "compensation_action_failed" | "destructive_escalation";
    detail: string;
}
...
export type UnwindEvent = ToolCallTracked | ToolCallCompleted | ToolCallFailed | CompensationStarted | CompensationCompleted | CompensationFailed | ApprovalRequested | ApprovalReceived | RunCompleted | RunFailed;
export {};
